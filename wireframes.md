...
| 2026-09-24 | Homepage: “AI at Fullsteam” callout (label + lorem + pill → `#ai`) added as a sibling between `#solutions` and the verticals film (`#industries`), and inside the Offerings scene (`#offerings`) — same markup; industries callout not inside the dark film. |
